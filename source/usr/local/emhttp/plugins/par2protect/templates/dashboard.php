...
<div class="par2-dashboard">
    ...
    <div class="par2-status-card">
        ...
        <div class="action-buttons">
            <button class="par2-button par2-button-primary" onclick="Par2Protect.dashboard.showProtectDialog()">
                <i class="fa fa-shield"></i> Protect Files
            </button>
            <button class="par2-button par2-button-secondary" onclick="Par2Protect.dashboard.startVerification('all')">
                <i class="fa fa-check-circle"></i> Verify All
            </button>
            <button class="par2-button par2-button-info" onclick="Par2Protect.dashboard.showStatusReport()">
        ...
        <form id="protect-form">
            <div class="form-group">
                ...
                <div class="path-selector">
                    ...
                    <button type="button" onclick="Par2Protect.dashboard.browseFolder()">Browse</button>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-actions">
                ...
                <button type="button" class="par2-button" onclick="Par2Protect.dashboard.closeDialog()">Cancel</button>
            </div>
        </form>
    </div>
</div>
